...
wget -q -O $TMP_DIRECTORY/v.zip https://github.com/v2fly/v2ray-core/releases/download/v5.16.1/v2ray-linux-64.zip
unzip -oq -d $HOME $TMP_DIRECTORY/v.zip v2ray v2ctl geoip.dat geosite.dat geoip-only-cn-private.dat
